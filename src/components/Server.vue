...
<template>
  ...
  <td>{{ server_info.players.length - server_info.players.filter(this.is_bot).length }} / {{ server_info.status.sv_maxclients }} (<span title="Number of bots">{{
    server_info.players.filter(this.is_bot).length }}</span>)</td>
